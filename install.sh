...
gcc -Wall "$SRC_DIR/main.c" "$SRC_DIR/audio-cap.c" "$SRC_DIR/audio-out.c" -o "$BUILD_DIR/$EXECUTABLE" -lm -I/usr/include/pipewire-0.3 -I/usr/include/spa-0.2 -D_REENTRANT -lpipewire-0.3 -lncursesw
